...
Deadline without \texttt{else} (\ty{result}) & no & \texttt{else} is required \\
\texttt{is\_ok} / \texttt{value} & no & likewise \\
\texttt{replyto} / \texttt{answer} / parameter \texttt{reply} & no & first-class replies unsupported \\
\texttt{acquire} / \texttt{release} & no & \texttt{unsupported call} \\
